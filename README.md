...
- Modeled data into a structured format for analysis (star schema approach)
- Created key business KPIs:
  - Total Revenue
...
- Identified and compared **churned vs retained customers**
- Calculated key metric:
  - **Churn rate (~17.7%)**
- Analyzed behavioral patterns linked to churn
